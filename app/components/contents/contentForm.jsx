...
export const ContentForm = ({ isEditing = false }) => {
  ...
  useEffect(() => {
    if (isEditing && loaderData) {
      setFormData({
        ...
        image_alignment: loaderData.image_alignment || "center", // New field
        image_size: loaderData.image_size || "medium", // New field
      });
  ...
  // Update fieldDefinitions to include image alignment and size
  const fieldDefinitions = [
    { name: "Banner Image", key: "logo", type: "drop_zone" },
    {
      name: "Image Alignment", // New field
      key: "image_alignment",
      type: "select",
      options: [
